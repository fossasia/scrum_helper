...
class EmailClientAdapter {
	...
	/**
	 * Helper to insert HTML content.
	 * Prioritizes execCommand for better editor integration (especially Firefox).
	 * Falls back to DOMParser + replaceChildren to avoid unsafe innerHTML assignment.
	...
	/**
	 * Safely sets HTML content using DOMParser to avoid innerHTML XSS warnings.
	 */
	_safeSetHTML(element, content) {
