  ...
  function initializePopup() {
    ...
    browser.storage.local
      ...
      .then((result) => {
        ...
        if (userReasonInput && result.userReason)
          userReasonInput.value = result.userReason;
    ...
    const scrumReport = document.getElementById("scrumReport");
    let persistBlockerReason = async () => {};
