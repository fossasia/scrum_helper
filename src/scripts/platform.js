(function () {
	...
	window.addEventListener('error', function (event) {
		...
		div.innerHTML =
			'<h1 style="font-size: 20px; font-weight: bold; margin-bottom: 10px;">JavaScript Error Detected</h1>' +
			'<p style="margin-bottom: 5px;"><b>Message:</b> ' +
			event.message +
			'</p>' +
			'<p style="margin-bottom: 15px;"><b>Source:</b> ' +
			event.filename +
			':' +
			event.lineno +
			':' +
			event.colno +
			'</p>' +
			'<pre style="background: rgba(0,0,0,0.5); padding: 10px; border-radius: 5px;">' +
